/***************************************************************
    ...
    *  loss of information.
    *          
    *  To edit the test, open the file ‘Order flight API.st’ 
    *  in HP Service Test.
     ***************************************************************/
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>Frankfurt</DepartureCity><ArrivalCity>Paris</ArrivalCity><FlightDate>2022-07-05T00:00:00+03:00</FlightDate></GetFlights></Body></Envelope>");
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/"" xmlns:p1=""http://www.w3.org/2001/XMLSchema-instance""><Body><CreateFlightOrder xmlns=""HP.SOAQ.SampleApp""><FlightOrder><Class>Business</Class><CustomerName>muli</CustomerName><DepartureDate>2021-07-06T00:00:00+03:00</DepartureDate><FlightNumber>{Step.OutputProperties.StServiceCallActivity4.Body.GetFlightsResponse.GetFlightsResult.Flight[1].FlightNumber}</FlightNumber><NumberOfTickets>3</NumberOfTickets></FlightOrder></CreateFlightOrder></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi57 = new VTDPropertyInfoBase("OutputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='GetFlightsResponse'][1]/*[local-name(.)='GetFlightsResult'][1]/*[local-name(.)='Flight'][{Array0}]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseGetter binding_getter29 = new VTDXPathGetter(pi57,XmlTypeCode.Int);
            binding_getter29 = new XPathGetterDecorator(binding_getter29,"{Array0}",1);
            VTDPropertyInfoBase pi58 = new VTDPropertyInfoBase("InputEnvelope","/*[local-name(.)='Envelope'][1]/*[local-name(.)='Body'][1]/*[local-name(.)='CreateFlightOrder'][1]/*[local-name(.)='FlightOrder'][1]/*[local-name(.)='FlightNumber'][1]");
            VTDBaseSetter binding_setter29 = new VTDXPathSetter(pi58,XmlTypeCode.Int);
            bind_dir29 = new BindDirection(_flow.StServiceCallActivity4,binding_getter29,binding_setter29,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity6.InDirections.Add(bind_dir29);
